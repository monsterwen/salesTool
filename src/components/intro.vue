...
<!--    &lt;!&ndash; start templatemo navigation &ndash;&gt;-->
...
<!--                    <span class="icon icon-bar"></span>-->
<!--                </button>-->
<!--                <a href="#" class="navbar-brand">Composite</a>-->
<!--            </div>-->
...
<!--        </div>-->
<!--    </nav>-->
<!--    &lt;!&ndash; end templatemo navigation &ndash;&gt;-->
...
<!--        </div>-->
<!--    </section>-->
<!--    &lt;!&ndash; start templatemo features &ndash;&gt;-->
...
<!--                <div class="col-md-8">-->
<!--                    <h2>SOME FEATURES</h2>-->
<!--                    <p>Composite is free responsive mobile template from <span class="blue">template</span><span class="green">mo</span>.com website. Feel free to use this layout for any website project. Please tell your friends about us. Thank you.</p>-->
<!--                </div>-->
...
<!--        </div>-->
<!--    </section>-->
<!--    &lt;!&ndash; end templatemo features &ndash;&gt;-->

<!--    &lt;!&ndash; start templatemo about &ndash;&gt;-->
<!--    <section id="about">-->
<!--        <div class="container">-->
<!--            <div class="row">-->
<!--                <div class="col-md-2"></div>-->
...
<!--                    <h2>ABOUT US</h2>-->
<!--                    <p>Etiam elementum laoreet mauris. Ut rutrum feugiat neque. Suspendisse viverra gravida nulla. Duis sed enim vitae metus nonummy venenatis.</p>-->
<!--                </div>-->
<!--                <div class="col-md-12"></div>-->
<!--                <div class="col-sm-6 col-md-6 info">-->
<!--                    <h3>We are COMPOSITE</h3>-->
<!--                    <h4>WEB DESIGN &AMP; DEVELOPMENT AGENCY</h4>-->
<!--                    <p>Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vestibulum dapibus lectus 	a ligula blandit ac egestas ipsum facilisis toque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vestibulum dapibus lectus 	a ligula blandit ac egestas ipsum facilisi.</p>-->
<!--                    <p>Suspendisse potenti. Etiam elementum laoreet mauris. Ut rutrum feugiat neque. Suspendisse viverra gravida nulla. Duis sed enim vitae metus nonummy venenatis. Curabitur semper rutrum sapien. Mauris luctus.</p>-->
<!--                </div>-->
...
<!--        </div>-->
<!--    </section>-->
<!--    &lt;!&ndash; end templatemo about &ndash;&gt;-->

<!--    &lt;!&ndash; start templatemo team &ndash;&gt;-->
...
<!--                <div class="col-md-8">-->
<!--                    <h2>MEET THE TEAM</h2>-->
<!--                    <p>Etiam elementum laoreet mauris. Ut rutrum feugiat neque. Suspendisse viverra gravida nulla. Duis sed enim vitae metus nonummy venenatis. Curabitur semper rutrum sapien. Mauris luctus.</p>-->
<!--                </div>-->
<!--                <div class="col-md-12"></div>-->
<!--                <div class="col-sm-6 col-md-3">-->
<!--                    <img src="../assets/images/member1.jpg" class="img-responsive" alt="team 1">-->
<!--                    <h3>TRACY</h3>-->
<!--                    <p>DESIGNER</p>-->
<!--                </div>-->
<!--                <div class="col-sm-6 col-md-3">-->
<!--                    <img src="../assets/images/member2.jpg" class="img-responsive" alt="team 2">-->
<!--                    <h3>MARY</h3>-->
<!--                    <p>DEVELOPER</p>-->
<!--                </div>-->
<!--                <div class="col-sm-6 col-md-3">-->
<!--                    <img src="../assets/images/member3.jpg" class="img-responsive" alt="team 3">-->
<!--                    <h3>JULIA</h3>-->
<!--                    <p>DIRECTOR</p>-->
<!--                </div>-->
<!--                <div class="col-sm-6 col-md-3">-->
<!--                    <img src="../assets/images/member4.jpg" class="img-responsive" alt="team 4">-->
<!--                    <h3>LINDA</h3>-->
<!--                    <p>MANAGER</p>-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
<!--    </section>-->
<!--    &lt;!&ndash; end templatemo team &ndash;&gt;-->

<!--    &lt;!&ndash; start templatemo portfolio &ndash;&gt;-->
...
<!--                        <img src="../assets/images/p1.jpg" class="img-responsive" alt="work">-->
...
<!--                <div class="col-sm-6 col-md-3">-->
<!--                    <div class="image_thumb">-->
<!--                        <img src="../assets/images/p2.jpg" class="img-responsive" alt="work">-->
<!--                        <div class="image_overlay">-->
<!--                            <a href="#"><i class="fa fa-thumbs-o-up"></i></a>-->
<!--                        </div>-->
<!--                    </div>-->
...
<!--                <div class="col-sm-6 col-md-3">-->
<!--                    <div class="image_thumb">-->
<!--                        <img src="../assets/images/p3.jpg" class="img-responsive" alt="work">-->
<!--                        <div class="image_overlay">-->
<!--                            <a href="#"><i class="fa fa-thumbs-o-up"></i></a>-->
<!--                        </div>-->
<!--                    </div>-->
...
<!--                <div class="col-sm-6 col-md-3">-->
<!--                    <div class="image_thumb">-->
<!--                        <img src="../assets/images/p4.jpg" class="img-responsive" alt="work">-->
<!--                        <div class="image_overlay">-->
<!--                            <a href="#"><i class="fa fa-thumbs-o-up"></i></a>-->
<!--                        </div>-->
<!--                    </div>-->
...
<!--                <div class="col-sm-6 col-md-3">-->
<!--                    <div class="image_thumb">-->
<!--                        <img src="../assets/images/p5.jpg" class="img-responsive" alt="work">-->
<!--                        <div class="image_overlay">-->
<!--                            <a href="#"><i class="fa fa-thumbs-o-up"></i></a>-->
<!--                        </div>-->
<!--                    </div>-->
...
<!--                <div class="col-sm-6 col-md-3">-->
<!--                    <div class="image_thumb">-->
<!--                        <img src="../assets/images/p6.jpg" class="img-responsive" alt="work">-->
<!--                        <div class="image_overlay">-->
<!--                            <a href="#"><i class="fa fa-thumbs-o-up"></i></a>-->
<!--                        </div>-->
<!--                    </div>-->
...
<!--                <div class="col-sm-6 col-md-3">-->
<!--                    <div class="image_thumb">-->
<!--                        <img src="../assets/images/p7.jpg" class="img-responsive" alt="work">-->
<!--                        <div class="image_overlay">-->
<!--                            <a href="#"><i class="fa fa-thumbs-o-up"></i></a>-->
<!--                        </div>-->
<!--                    </div>-->
...
<!--                <div class="col-sm-6 col-md-3">-->
<!--                    <div class="image_thumb">-->
<!--                        <img src="../assets/images/p8.jpg" class="img-responsive" alt="work">-->
<!--                        <div class="image_overlay">-->
<!--                            <a href="#"><i class="fa fa-thumbs-o-up"></i></a>-->
<!--                        </div>-->
<!--                    </div>-->
...
<!--        </div>-->
<!--    </section>-->
<!--    &lt;!&ndash; end templatemo portfolio &ndash;&gt;-->

<!--    &lt;!&ndash; start templatemo contact &ndash;&gt;-->
<!--    <section id="contact">-->
<!--        <div class="container">-->
<!--            <div class="row">-->
<!--                <div class="col-md-2"></div>-->
...
<!--        </div>-->
<!--    </section>-->
<!--    &lt;!&ndash; end templatemo contact &ndash;&gt;-->

<!--    &lt;!&ndash; start templatemo footer &ndash;&gt;-->
...
<!--        </div>-->
<!--    </footer>-->
<!--    &lt;!&ndash; end templatemo footer &ndash;&gt;-->

<!--    &lt;!&ndash; start back to top &ndash;&gt;-->
<!--    <a href="#top" class="go-top"><i class="fa fa-chevron-up fa-1x"></i></a>-->
<!--    &lt;!&ndash; end back to top &ndash;&gt;-->


<!--    &lt;!&ndash; end templatemo back to top js &ndash;&gt;-->
